...
if __name__ == '__main__':
    ...
    parser.add_argument('--pretrain_weight_decay', type=float,
                        default=0.0001, help='weight decay for regularization')
    ...
    parser.add_argument('--pc_augm', action='store_true', default=True, help='Training augmentation for points in each superpoint')
