...
if __name__ == '__main__':
    ...
    #data
    parser.add_argument('--phase', type=str, default='mptieval', choices=['pretrain', 'finetune',
    ...
    parser.add_argument('--model_checkpoint_path', type=str, default='/media/user/volume2/dip21e033-2/shuqian/PointCloud/attMPTI_1/logs/log_s3dis/log_mpti_s3dis_S0_N2_K1_Att1',
                        help='Path to the checkpoint of model for resuming')
    parser.add_argument('--save_path', type=str, default='/media/user/volume2/dip21e033-2/shuqian/PointCloud/attMPTI_1/logs/log_s3dis/log_mpti_s3dis_S0_N2_K1_Att1',
