...
if __name__ == '__main__':
    ...
    parser.add_argument('--pc_augm', action='store_true', default=True,
                        help='Training augmentation for points in each superpoint')
    ...
    if args.phase=='mptitrain':  # multi-prototype train
